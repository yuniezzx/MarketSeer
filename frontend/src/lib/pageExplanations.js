  ...
  "/dragon-tiger": {
    ...
    summary: {
      ...
      fields: [
        ...
        {
          name: "平均净买额占比(%)",
          description: "反映龙虎榜资金相对于市场整体的净买入/卖出强度。计算方式：平均每次上榜的龙虎榜净买额占市场总成交额的百分比。正值表示净买入，数值越大说明上榜资金买入意愿越强；负值表示净卖出"
        },
        {
          name: "平均成交额占比(%)",
          description: "反映龙虎榜资金相对于市场整体的活跃程度。计算方式：平均每次上榜的龙虎榜成交额占市场总成交额的百分比。数值越大说明上榜资金的参与度和活跃程度越高"
        },
        {
          name: "趋势图表",
