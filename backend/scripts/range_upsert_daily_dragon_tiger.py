...
使用示例：
    # 导入指定日期数据
    python scripts/range_upsert_daily_dragon_tiger.py --date 20251219

    # 导入日期范围数据
    python scripts/range_upsert_daily_dragon_tiger.py --start-date 20251215 --end-date 20251219
"""
...
def import_single_date(service: DragonTigerService, date: str) -> bool:
    """
    导入单个日期的数据
